...
#### EDA 프로젝트 자료 소개
> * Dataset
>   * [kospi_data.csv](https://dacon.io/competitions/official/235980/data) : 대략적으로 어떤 데이터인지 설명을 적어주세요. Ex. KOSPI의 일간 등락, 종가, 시가 등의 정보를 담고 있는 데이터입니다.
...
|이름|활동 내용| 
|:---|:---:| 
|강건우| -저소득게층의 소득형태에 따른 신용등급 변화 barplot<br> -교육수준에 따른 신용등급의 변화 barplot<br> -낮은 교육수준의 사람들의 평균 연령 비교 barplot| 
