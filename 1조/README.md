...
>   * EDA_1조_코드(1).ipynb : 대략적으로 어떤 코드인지 설명을 적어주세요. Ex. xx데이터 수집을 위한 크롤링 코드입니다.
>   * EDA_1조_코드(2).ipynb : 대략적으로 어떤 코드인지 설명을 적어주세요. Ex. xxtask를 수행하기 위한 시각화 및 통계적 검정과 관련된 코드입니다.
<br/>
